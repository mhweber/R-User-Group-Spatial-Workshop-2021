...
#### This step should have given you an error {.challenge}
THIS IS VERY COMMON WORKING WITH SPATIAL DATA IN R AND USING `sf`.

#### Fix for the error {.solution}
...
#### Why did I use `as.numeric` in the `mutate` statement above? {.challenge}
