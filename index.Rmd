...
## Workshop agenda
  ...
  + 1:00pm - 1:45pm EDT: [Intro and quick intro to R spatial objects and methods](https://mhweber.github.io/R-User-Group-Spatial-Workshop-2021/index.html)
  + 1:45pm - 2:15pm EDT: [Getting spatial data into R](https://mhweber.github.io/R-User-Group-Spatial-Workshop-2021/reading-in-spatial-data.html)
  + 2:15pm - 2:20pm Break
  + 2:20pm - 2:35pm EDT: [Understanding coordinate reference systems (CRS)](https://mhweber.github.io/R-User-Group-Spatial-Workshop-2021/coordinate-reference-systems.html)
  + 2:35pm - 2:45pm Break
  + 2:45pm - 3:15pm EDT: [Vector data with sf](https://mhweber.github.io/R-User-Group-Spatial-Workshop-2021/vector-data-with-sf.html)
  + 3:15pm - 3:20pm Break
  + 3:20pm - 3:45pm EDT: [Raster data](https://mhweber.github.io/R-User-Group-Spatial-Workshop-2021/raster-data.html)
  + 3:45pm - 4:15pm EDT: [Geoprocessing](https://mhweber.github.io/R-User-Group-Spatial-Workshop-2021/geoprocessing.html)
  + 4:15pm - 4:45pm EDT: [Learning ways to map and visualize spatial data](https://mhweber.github.io/R-User-Group-Spatial-Workshop-2021/visualizing-spatial-data.html)
  + 4:45pm - 5:00pm EDT:[Extensions to work with GIS data in R](https://mhweber.github.io/R-User-Group-Spatial-Workshop-2021/extensions-to-work-with-gis-software-in-r.html) and questions
...
### Interactive mapping
```{r mapview example, fig.width=8,message=FALSE, error=FALSE, warning=FALSE}
library(mapview)
