...
## Workshop agenda
  ...
  + 1:30pm - 2:00pm EDT: [Getting spatial data into R](https://mhweber.github.io/R-User-Group-Spatial-Workshop-2021/reading-in-spatial-data.html) 
  ...
  + 3:00pm - 3:30pm EDT: [Vector data with sf](https://mhweber.github.io/R-User-Group-Spatial-Workshop-2021/vector-data-with-sf.html)
...
- Packages you need installed
  ...
  + `terra`
  + `spDataLarge`
  + [Rspatialworkshop](https://github.com/mhweber/Rspatialworkshop) - data for this workshop contained in package - install with: 
    - library(devtools)
