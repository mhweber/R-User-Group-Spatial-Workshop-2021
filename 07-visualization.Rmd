...
### Exercise
Using the example in post above, get counties for your state using `maps` package as shown in example, and geocode a couple cities in your state to plot as well using the geocoding from the [intro to the workshop using tmaptools](https://r-spatial.org/r/2018/10/25/ggplot2-sf-2.html).  Igonore the extra packages and some of the bells and whistles, just try adding a few of the ggplot parameters to make an interesting map
